...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        var randColor1 = myColors.fetchRandomColor()
        color = myColors.hexStringToUIColor(randColor1.hexValue)
        
        var randColor2 = myColors.fetchRandomColor()
        ...
        if(buttonAnswer == 2){
            ...
            btnAnswer2OUTLET.setTitle(randColor2.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(randColor1.colorName, forState: UIControlState.Normal)
            button3Correct = true
        }
    ...
    func changeColor() -> Bool{
        ...
        lblChangeColor.backgroundColor = color
