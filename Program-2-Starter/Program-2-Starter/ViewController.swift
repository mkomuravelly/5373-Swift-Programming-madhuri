...
class ViewController: UIViewController , ColorTableViewControllerDelegate{
    ...
    //BOutlet weak var greenSlider: UISlider!
    ...
    func ColorTableViewChooseColor(controller: ColorTableViewController, chosenColor color: String){
        ...
        rgblbl.text = String(format: "%.f", 255*rgb.R)+" "+String(format: "%.f", 255*rgb.G)+" "+String(format: "%.f", 255*rgb.B)
        hsllbl.text = String(format: "%.f", 255*hsl.H)+" "+String(format: "%.f", 255*hsl.S)+" "+String(format: "%.f", 255*hsl.L)
        hsvlbl.text = String(format: "%.f", 255*hsv.H)+" "+String(format: "%.f", 255*hsv.S)+" "+String(format: "%.f", 255*hsv.V)
